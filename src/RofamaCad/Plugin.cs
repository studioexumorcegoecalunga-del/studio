...
public sealed class Plugin : IExtensionApplication
{
    ...
    static void CreateRibbon()
    {
        ...
        AddPanel(tab, "Estrutural", new[] { ("Configurar","RFESTCONFIG "),("Auto lançar","RFESTRUTURA "),("Pilar","RFPILAR "),("Viga","RFVIGA "),("Laje","RFLAJEEST "),("Estrutura 3D","RFESTRUTURA3D "),("Numerar","RFESTNUMERAR "),("Carga Laje","RFCARGALAJE "),("Sapata","RFSAPATA ") });
