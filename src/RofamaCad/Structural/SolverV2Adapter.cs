...
{
 public static UnifiedBeamSolverV2.Result Solve(double[] spans,double[] ei,double[] q,bool[] fixV,bool[] fixR,ReleaseModelService.Flags[] releases,IReadOnlyList<UnifiedBeamSolver.PointLoad> points){
