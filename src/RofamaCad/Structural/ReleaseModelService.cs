...
internal static class ReleaseModelService
{
 ...
 public sealed record Flags(bool Start,bool End);
 ...
 public static Flags[] Parse(Autodesk.AutoCAD.DatabaseServices.Entity e,Autodesk.AutoCAD.DatabaseServices.Transaction tr,int elements){
  var f=Flags(elements,Parse(e,tr));var r=new Flags[elements];for(int i=0;i<elements;i++)r[i]=new(f[i,0],f[i,1]);return r;
 }
