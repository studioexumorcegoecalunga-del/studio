...
internal static class BeamPostProcessor
{
 ...
 public sealed record SamplePoint(int Element,double X,double GlobalX,double V,double M,double Deflection);
 public static List<SamplePoint> Sample(double[] L,double[] EI,double[] W,double[] displacement,double[] endForce,IReadOnlyList<PointLoad> points,int divisions=40){
  var r=new List<SamplePoint>();double gx=0;
